...
// in simulator we redefine to format for AutonomApp Developer console
...
{\
	NSString * exceptionName = [@"org.autonomapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.autonomapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAutonomAppNativeItemNone = -1, 
	UIAutonomAppNativeItemSpinner = -2,
	UIAutonomAppNativeItemProgressBar = -3,
	
	UIAutonomAppNativeItemSlider = -4,
	UIAutonomAppNativeItemSwitch = -5,
	UIAutonomAppNativeItemMultiButton = -6,
	UIAutonomAppNativeItemSegmented = -7,
	
	UIAutonomAppNativeItemTextView = -8,
	UIAutonomAppNativeItemTextField = -9,
	UIAutonomAppNativeItemSearchBar = -10,
	
	UIAutonomAppNativeItemPicker = -11,
	UIAutonomAppNativeItemDatePicker = -12,
	
	UIAutonomAppNativeItemInfoLight = -13,
	UIAutonomAppNativeItemInfoDark = -14,
	
	UIAutonomAppNativeItemDisclosure = -15,
	
	UIAutonomAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AutonomApp instances of
