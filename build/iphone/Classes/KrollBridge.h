...
@interface AutonomAppObject : KrollCoverageObject {
#else
@interface AutonomAppObject : KrollObject {
#endif
@private
...
extern NSString * AutonomApp$ModuleRequireFormat;
