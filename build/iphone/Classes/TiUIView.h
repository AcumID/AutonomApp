...
/**
 Base class for all AutonomApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AutonomApp view hierarchy (such as wrapped iOS UIViews) was touched.
