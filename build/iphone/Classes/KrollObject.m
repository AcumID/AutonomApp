...
//@interface AutonomAppObject : NSObject
//@end

@interface AutonomAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AutonomAppObject class]])
		{
			for (NSString *key in [[(AutonomAppObject*)o modules] allKeys])
			{
