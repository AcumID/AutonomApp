...
var popOverRegged = Ti.UI.iPad.createPopover({
	height:400,
	width:300,
	title:"Ændre indstilling",
...
tableView.addEventListener('click', function(e) {
		...
		function displayPopOver(){
			...
			//TODO Add only once hack-view fix is missing
...
tableViewSelected.addEventListener('click',function(e){
	...
	function displayPopOver(){
		...
		popOverRegged.show({view:pickerView, rect:{height:200, width:200, x:-355, y:-100}});
		numberInputFieldRegged.focus();
	};
});

numberInputFieldRegged.addEventListener('return',function(e){
	console.log("OH EDIT DATA YA?");
	//TODO UpdateNumber for ReggedDataElement
	tableViewSelected.data = tbl_data_selected;
...
delButton.addEventListener('click',function(e){
	...
	//TODO How do we get the index of the row of the popover?
